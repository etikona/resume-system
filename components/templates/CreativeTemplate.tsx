...
export default function CreativeTemplate({ resume }: CreativeTemplateProps) {
  return (
    <div className="bg-gradient-to-br from-white to-slate-50 text-slate-800 p-8 max-w-4xl mx-auto shadow-xl rounded-2xl border border-slate-200">
      {/* Header */}
          ...
          {resume.summary && (
            <section>
              <h2 className="text-xl font-semibold text-slate-900 mb-3 flex items-center">
                <span className="w-3 h-3 bg-slate-900 rounded-full mr-2"></span>
                About Me
              </h2>
              <p className="text-slate-700 text-sm leading-relaxed bg-white p-4 rounded-lg shadow-sm">
                {resume.summary}
              </p>
            </section>
          )}
